...
class ObjRevolucion : public Malla3D
{
   ...
   void draw(int opcion, std::vector<bool> edicion, bool tapas);
protected:
    int numero_instancias;
    void crearMalla(std::vector<Tupla3f> perfil_original, int num_instancias, bool tap_sup, bool tap_inf);
